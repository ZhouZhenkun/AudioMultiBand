...
%COMPAND Computes source code mu-law or A-law compressor or expander. 
%       OUT = COMPAND(IN, PARAM, V) computes mu-law compressor with mu given 
%       in PARAM and the peak magnitude given in V. 
% 
%       OUT = COMPAND(IN, PARAM, V, METHOD) mu-law or A-law compressor or 
%       expander computation with the computation method given in METHOD. 
%       PARAM provides the mu or A value. V provides the input signal peak  
%       magnitude. METHOD can be chosen as one of the following: 
...
%       Wes Wang 10/13/94, 9/30/95. 
%       Copyright (c) 1995-96 by The MathWorks, Inc. 
%       $Revision: 1.1 $  $Date: 1996/04/01 17:54:01 $ 
