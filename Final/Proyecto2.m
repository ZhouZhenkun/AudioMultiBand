...
compressedFileName = 'audio.bin';
outFileName = 'outTest.wav';
...
nCode1 =14; % Bits for band 1 quantization
nCode2 =4;  % Bits for band 2 quantization
nCode3 =3;  % Bits for band 3 quantization
nCode4 =3;  % Bits for band 4 quantization
...
% Using Mu's Law and a typical factor of 255 and V as the max value of the
% signal
Mu = 255;
...
% cCodes work to establish the writting lenght
% Lloyds algorithm is used to get optimized partition and codebook for
% quantization
...
% Shifting is done to keep the MSB bytes
...
fileID = fopen(compressedFileName,'w');
...
%% New File output
audiowrite(outFileName,newRealSignal,Fs);
